...
nobel_living_science %>%
   ...
   coord_flip()
```
From the graph we can see that, most of the Nobel winners in physics, medicine, chemistry and economics were based on USA. And that supports the Buzzfeed headline.
